          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center px-4 sm:px-6">
              <div className="relative w-full max-w-5xl text-center text-white px-2 sm:px-4 py-8 sm:py-10">
                ...
                <p className="text-[11px] sm:text-xs tracking-[0.28em] uppercase text-black/90 drop-shadow-[0_2px_6px_rgba(0,0,0,0.6)]">
                Origen Algarrobo
              </p>
                <p className="mt-1 text-[11px] sm:text-xs tracking-[0.22em] uppercase text-white/90 drop-shadow-[0_2px_6px_rgba(0,0,0,0.6)]">
                by La Chaucha
                </p>
              </div>
